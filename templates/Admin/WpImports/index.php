...
<?php $this->BcBaser->css('BcWpImport.admin/wp_import', ['block' => true]) ?>
  ...
  <section class="bca-section" data-bca-section-type="form-group" id="js-pending-section">
    ...
    <div class="bca-actions" id="js-pending-bulk-actions">
      ...
      <div class="bca-actions__main">
        <?= $this->BcAdminForm->button(__d('baser_core', '選択した未完了ジョブを削除'), [
          'type' => 'button',
          'id' => 'js-pending-delete-all-btn',
...
<section class="bca-section" data-bca-section-type="form-group" id="js-upload-section">
  ...
  <div id="js-import-settings-wrapper" style="display:none;">
    <div class="bca-collapse__action">
      <?= $this->BcAdminForm->button(
        __d('baser_core', 'インポート設定') . '&nbsp;&nbsp;<i class="bca-icon--chevron-down bca-collapse__btn-icon"></i>',
        [
          'type' => 'button',
  ...
  <div class="bca-actions">
    <div class="bca-actions__before"></div>
    <div class="bca-actions__main">
      <?= $this->BcAdminForm->button(__d('baser_core', 'アップロードして解析'), [
        'type' => 'button',
        'id' => 'js-upload-analyze-btn',
        'class' => 'bca-btn bca-actions__item',
        'data-bca-btn-type' => 'save',
        'data-bca-btn-size' => 'lg',
        'data-bca-btn-width' => 'lg',
      ]) ?>
      <?= $this->BcAdminForm->button(__d('baser_core', 'インポート実行'), [
        'type' => 'button',
        'id' => 'js-start-import-btn',
        'class' => 'bca-btn bca-actions__item',
        'data-bca-btn-type' => 'save',
        'data-bca-btn-size' => 'lg',
        'data-bca-btn-width' => 'lg',
...
<section class="bca-section" data-bca-section-type="form-group" id="js-result-section" style="display:none;">
  ...
  <table class="form-table bca-form-table" data-bca-table-type="type2">
    <tbody>
      ...
      <tr id="js-skip-row" style="display:none;">
        <th class="col-head bca-form-table__label"><?= __d('baser_core', 'スキップ件数') ?></th>
        <td class="col-input bca-form-table__input" id="js-res-skip">-</td>
      </tr>
